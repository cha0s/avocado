...
Promise.prototype.progress = function(progressor) {
  this._progressors.push(progressor);
}
...
function defer() {
  ...
  promise.notify = function(value) {
    for (var i = 0; i < this._progressors.length; i++) {
      this._progressors[i](value);
    }
  }
...
module.exports = {
  ...
  , delay: delay
  , fcall: fcall
  , isPromise: function(maybe) { return 'object' === typeof maybe && 'function' === typeof maybe.then; }
  , resolve: resolve
  , reject: reject
}