...
describe 'EventEmitter', ->
  ...
  it "can listen to signals on event name", ->
    ...
    expect(spy.namedEvents.calls.count()).toEqual 1
  ...
  it "can listen to signals on event name, with a namespace", ->
    ...
    expect(spy.namespacedEvents.calls.count()).toEqual 1
  ...
  it "can listen to signals only once", ->
    ...
    expect(spy.onceEvent.calls.count()).toEqual 1
  ...
  it "can remove signal listeners by name and function", ->
    ...
    expect(spy.removeListenerNameFunction.calls.count()).toEqual 1
  ...
  it "can remove signal listeners by name and namespace", ->
    ...
    expect(spy.removeListenerNameAndNamespace.calls.count()).toEqual 1
  ...
  it "can remove signal listeners by namespace", ->
    ...
    expect(spy.removeListenerNamespace.calls.count()).toEqual 1
  ...
  it "can remove signal listeners by name", ->
    ...
    expect(spy.removeListenerName.calls.count()).toEqual 1
  ...
  describe 'regressions', ->
    ...
    it "can listen to namespaced signals only once", ->
      ...
      expect(->
        ...
        expect(spy.onceEventNamespace.calls.count()).toEqual 1
